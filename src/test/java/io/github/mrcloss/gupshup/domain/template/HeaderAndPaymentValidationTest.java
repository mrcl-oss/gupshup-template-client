...
public class HeaderAndPaymentValidationTest {
    ...
    public void shouldNotAllowMoreThanOnePayNowButton() {
        ...
        template.addButton(new PayNowButton("Pay 1", true, new StaticUrlButton("URL", "https://example.com/pay1")));
        
        assertThrows(IllegalArgumentException.class, () -> {
            template.addButton(new PayNowButton("Pay 2", true, new StaticUrlButton("URL", "https://example.com/pay2")));
    ...
    public void payNowButtonShouldOnlyBeAllowedInTextTemplate() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            template.addButton(new PayNowButton("Pay", true, new StaticUrlButton("URL", "https://example.com/pay")));
            template.validate();
