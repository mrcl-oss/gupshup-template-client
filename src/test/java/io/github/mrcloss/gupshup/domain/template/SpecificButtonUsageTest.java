...
public class SpecificButtonUsageTest {
    ...
    private TextTemplate createTextTemplate() {
        TextTemplate template = new TextTemplate("test_text", LanguageCode.ENGLISH, "Hello", TemplateCategory.MARKETING, "app-123", null, TemplateParameterFormat.POSITIONAL);
        return template;
    }
}
