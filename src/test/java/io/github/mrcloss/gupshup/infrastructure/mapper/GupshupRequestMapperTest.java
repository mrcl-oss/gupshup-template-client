...
class GupshupRequestMapperTest {
    ...
    void testMapTextTemplateWithVariablesAndButtons() {
        ...
        PayNowButton payNowBtn = new PayNowButton("Pay", true, new StaticUrlButton("Pay", "https://pay.com"));
    ...
    void testMapAuthenticationTemplate() {
        ...
        assertEquals("Your code is {{1}}. For your security, do not share this code.", request.getContent());
        assertEquals("Your code is [123456]. For your security, do not share this code.", request.getExample());
