...
/**
 * Value Object representing a Language Code (e.g., "es", "en", "cat").
 * Designed as an extensible Pseudo-Enum to allow standard auto-completion
 * while supporting custom or future language codes without requiring library updates.
 */
public final class LanguageCode {
    ...
    /**
     * Factory Method. 
     * The @JsonCreator annotation instructs Jackson (and frameworks like Spring Data MongoDB) 
     * to use this method when converting a String from a JSON payload or database into this object.
     *
    ...
    /**
     * The @JsonValue annotation instructs Jackson that when serializing to Mongo 
     * or sending via HTTP, it should ONLY output this raw String value, 
     * rather than wrapping it in a complex JSON object.
     *
