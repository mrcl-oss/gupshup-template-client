...
public interface GupshupHttpService {
     ...
     * @return The response from Gupshup.
     */
    <T extends BaseGupshupResponse> T postForm(String path, Map<String, Object> body, Class<T> responseType);
     ...
     */
    <T extends BaseGupshupResponse> CompletableFuture<T> postFormAsync(String path, Map<String, Object> body, Class<T> responseType);
     ...
     * @return A CompletableFuture with the response.
     */
    <T extends BaseGupshupResponse> CompletableFuture<T> deleteAsync(String path, Class<T> responseType);
}
