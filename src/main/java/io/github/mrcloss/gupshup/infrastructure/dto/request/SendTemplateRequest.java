...
public class SendTemplateRequest {
    ...
    public SendTemplateRequest(String source, String destination, String srcName, String templateId, List<String> params, GupshupMessage message) {
        this.source = source;
    ...
    public SendTemplateRequest(String source, String destination, String srcName, String templateId, List<String> params) {
